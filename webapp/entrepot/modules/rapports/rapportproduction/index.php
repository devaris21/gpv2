                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <?php foreach ($quantites as $key => $qua) {
                                                                ...
                                                                <td style="padding: 4px; width: 50px;" class="text-center"><span class="gras"><?= $produit->conditionnement($date1, $date2, Home\FORMATEMBALLAGE::PRIMAIRE, $entrepot->id) ?></span><br><span><?= $qua->name() ?></span></td>
                                                            <?php } ?>
                                                        </tr>
                                                    </tbody>
                                                </table>
