                                            ...
                                            <?php $total = 0; foreach ($ressources as $key => $ressource) {
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <span class="float-right">
                                                        <span class="label label-<?= ($stock > 0)?"success":"danger" ?>"><?= round($stock, 2) ?> <?= $ressource->abbr ?></span>
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <?php foreach ($ressources as $key => $ressource) {  ?>
                                                            <th class="gras"><small><?= $ressource->name() ?></small></th>
                                                        <?php } ?>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    ...
                                                    while ($index <= $date2) { 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php foreach ($ressources as $key => $ressource) {  ?>
                                                                ...
                                                                data-html="true"
                                                                data-content="
                                                                <span>Stock de veille : <b>120</b></span><br>
                                                                <span>Production du jour : <b>120</b></span><br>
                                                                <span>Livraisons du jour : <b>120</b></span><br>
                                                                <span>Perte : <b>120</b></span>
                                                                <hr style='margin:1.5%'>
                                                                <span>En stock à ce jour : <b><?= round($ressource->stock($index), 2) ?> <?= $ressource->abbr ?></b></span><br> <span>">
                                                                    <?= round($ressource->stock($index), 2) ?> <?= $ressource->abbr ?>
                                                                </td>
                                                            <?php } ?>
                                                        </tr>
                                                        <?php
