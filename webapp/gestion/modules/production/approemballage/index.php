    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-9">
                <h2 class="text-uppercase text-warning gras">Les approvisionnements d'emballages en cours</h2>
                <div class="container">
                    <div class="row">
        ...
        <div class="ibox">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                   <button style="font-size: 11px; margin-top: -1.5%" data-toggle='modal' data-target="#modal-approemballage" class="btn btn-success dim"><i class="fa fa-plus"></i> Approvisionnement d'emballage</button>
               </div>
           </div>
                                        ...
                                        <thead>
                                            <tr class="no">
                                                <?php foreach ($appro->ligneapproemballages as $key => $ligne) { 
                                                    $ligne->actualise(); ?>
                                                    <th class="text-center text-uppercase"><?= $ligne->emballage->name() ?></th>
                                                <?php } ?>
                                            </tr>
                                        </thead>
                                        <tbody>
