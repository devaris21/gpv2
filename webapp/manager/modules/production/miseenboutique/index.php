                    ...
                    <tbody>
                        <?php foreach ($datas as $key => $mise) {
                            ...
                            <tr class="<?= ($mise->etat_id != Home\ETAT::ENCOURS)?'fini':'' ?> border-bottom">
                                ...
                                <td>
                                    <br>
                                    <a href="<?= $this->url("fiches", "master", "bonmiseenboutique", $mise->id) ?>" target="_blank" class="btn btn-block btn-white btn-sm"><i class="fa fa-file-text text-blue"></i> Voir le bon</a><br>
                                </td>
                            </td>
                        </tr>
                    <?php  } ?>
