                                            ...
                                            <table class="table table-striped table-hover table-striped">
                                                <tbody>
                                                    <?php foreach ($commandes as $key => $commande) {
                                                        $commande->actualise(); ?>
                                                        <tr>
                                                            <td><a href="<?= $this->url("gestion", "fiches", "boncommande", $commande->id)  ?>"><i class="fa fa-2x fa-file-text-o"></i></a></td>
                                                            <td>
                                            ...
                                            <table class="table table-striped table-hover table-striped">
                                                <tbody>
                                                    <?php foreach ($livraisons as $key => $livraison) {
                                                        $livraison->actualise(); ?>
                                                        <tr>
                                                            <td><a href="<?= $this->url("gestion", "fiches", "bonlivraison", $livraison->id)  ?>"><i class="fa fa-2x text-warning fa-file-text-o"></i></a></td>
                                                            <td>
