                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover table-operation">
                                                ...
                                                <tbody class="tableau">
                                                    ...
                                                    <?php foreach ($mouvements as $key => $mouvement) {  ?>
                                                        <tr>
                                                            <td class="text-center" width="15"><a target="_blank" href="<?= $this->url("boutique", "fiches", "boncaisse", $mouvement->getId())  ?>"><i class="fa fa-file-text-o fa-2x"></i></a> 
                                                            </td>
                                                            <td>
                                                                ...
                                                                <?php if ($employe->isAutoriser("modifier-supprimer")) { ?>
                                                                    |
                                                                    &nbsp;&nbsp;<i onclick="modifierOperation(<?= $mouvement->getId() ?>)" class="cursor fa fa-pencil text-dark"></i> 
                                                                    &nbsp;&nbsp;<i class="cursor fa fa-close text-red" onclick="suppressionWithPassword('operation', <?= $mouvement->getId() ?>)"></i>
                                                                <?php } ?>
                                           ...
                                           <!--  <td width="110" class="text-center" style="padding: 0; border-right: 2px dashed grey">
                                             <?php if ($mouvement->etat_id == Home\ETAT::ENCOURS) { ?>
                                                 <button style="padding: 2px 6px;" onclick="valider(<?= $mouvement->getId() ?>)" class="cursor simple_tag"><i class="fa fa-file-text-o"></i> Valider</button><span style="display: none">en attente</span>
                                             <?php } ?>
