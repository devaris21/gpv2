        ...
        <div id="page-wrapper" class="gray-bg">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-3">
               <div class="row">
                <div class="col-md-12">
                    <div class="widget style1 bg-blue">
                        <div class="row">
                            <div class="col-4">
                                <i class="fa fa-truck fa-3x"></i>
                            </div>
                            <div class="col-8 text-right">
                                <span> ventes en cave en cours </span>
                        ...
                        <?php foreach ($prospections as $key => $prospection) {
                            ...
                            <tr class="<?= ($prospection->etat_id != Home\ETAT::ENCOURS)?'fini':'' ?> border-bottom" style="border-bottom: 2px solid black">
                                ...
                                <td class="project-title border-right" style="width: 30%;">
                                    ...
                                    <h3 class="gras text-blue"><?= money($prospection->montant) ?> <?= $params->devise  ?></h3>
                                ...
                                <td>
                                    <a href="<?= $this->url("boutique", "fiches", "bonsortie", $prospection->getId()) ?>" target="_blank" class="btn btn-block btn-white btn-sm"><i class="fa fa-file-text text-blue"></i> Bon de sortie</a><br>
